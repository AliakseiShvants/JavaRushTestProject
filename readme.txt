...
4. В файле src/main/resources/META-INF/persistence.xml для свойства "hibernate.connection.url" нужно вместо локалхост указать реальный адрес сервера БД и порт, на котром она настроена
