        ...
        <tr>
            ...
            <td align=center>
                    <select name="admin">
                        ...
                        <option <c:if test="${sessionScope.searchCriteria.admin}"> selected </c:if> value="true">да</option>
                        <option <c:if test="${!sessionScope.searchCriteria.admin}"> selected </c:if> value="false">нет</option>
                       </select>
            </td>
            <td></td>
